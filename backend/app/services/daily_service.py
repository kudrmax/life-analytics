...
class DailyService:
    ...
    def _fill_free_checkpoints(self, item: dict, m: dict, entries: list, data: dict) -> None:
        """Fill free_entries list for free_checkpoints metrics."""
        mid = m["id"]
        free = sorted(
            [e for e in entries if e.get("is_free_checkpoint")],
