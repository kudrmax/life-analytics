    ...
    async def update_metric_on_import(
        ...
        await self.conn.execute(
            """UPDATE metric_definitions
               SET name=$1, category_id=$2, enabled=$3, sort_order=$4, icon=$5, private=$6, description=$7, hide_in_cards=$8, is_checkpoint=$9
               WHERE id=$10 AND user_id=$11""",
            name, category_id, enabled, sort_order, icon, is_private, description, hide_in_cards,
            is_checkpoint, metric_id, self.user_id,
        )
    ...
    async def create_metric_on_import(
        ...
        return await self.conn.fetchval(
            """INSERT INTO metric_definitions
               ...
               VALUES ($1,$2,$3,$4,$5,$6::metric_type,$7,$8,$9,$10,$11,$12) RETURNING id""",
